<template>
    <div class="wrapper fadeInDown">
        <div id="formContent">
            <p v-if="error" class="text-danger">Password or login is incorrect</p>
            ...
            <div id="formFooter">
                <router-link tag="button" :to="{name: 'register'}" type="button">Register?</router-link>
        ...
        methods:{
            login: function () {
                ...
                Api.login(this.username,this.password).then( (response) => {
                    ...
                    this.$router.go(this.$router.resolve({name: 'home'}).href);
                    app.error = false;
